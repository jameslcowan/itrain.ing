...
description: A quick walkthrough of mesocycles, weeks, days, and rows so you can ship your first shareable glute training plan.
...
Pick **lbs** or **kg** in the week bar. Open **Config** (sliders icon in the header) to enter your main lower-body lifts maxes plus custom lifts. When a max exists for an exercise, %1RM and load stay in sync on that row.
