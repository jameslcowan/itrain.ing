---
slug: programming-with-percentages-and-rpe
title: Programming With %1RM and RPE on the Same Row
description: Use estimated maxes to fill load from percentages, or log RPE when percentages drift. Both fit in one row.
...
Most spreadsheets force you to pick either percentage work or RPE. powerbuild.ing keeps **%1RM**, **load**, and **RPE** on the same row because real training blocks use all three.

## Set up maxes first

Open **Config** and enter best singles for your main lifts. Add other lifts (Romanian deadlift, close-grip bench) if you program them often. The dialog shows an **training total** as you type.
...
[Launch the app](/app) and try one heavy day with percentages plus one backoff row logged by RPE.
