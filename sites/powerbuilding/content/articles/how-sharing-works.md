...
title: How Sharing Works on powerbuild.ing
...
tags:
  ...
  - coaching
faq:
  - "Can anyone open my link? | Yes. Anyone with the full URL gets your whole program in powerbuild.ing — no login required. That open access is intentional so powerbuilding programming can spread."
...
When you tap **Share** in powerbuild.ing, you copy a link that contains your program. There is no separate export step and no account required. The program is compressed into the path of the URL.

## Open links by design

powerbuild.ing treats the share link as a feature, not a limitation. One URL opens the full grid for an athlete, a training partner, or a lifter you have never met who found your program in a forum or group chat. Coaches can pass along real blocks without paywalls or “request access” flows.

That matches what powerbuild.ing is for: **open powerbuilding knowledge** — programs people can actually use, not hoard.

Paid plans later will add **private programs** for coaches who need them. Free powerbuild.ing will keep open one-link sharing at the center.
...
[Launch powerbuild.ing](/app) with a blank week, add a day, then share. You will see the URL change as you edit.
